...
"Washington", "West Virginia", "Wisconsin", "Wyoming" };
    int votes[] = { 9,3,10,6,55,9,7,3,3,27,15,4,4,21,11,7,6,8,9,4,10,12,17,10,6,11,3,5,5,4,15
    ,5,31,15,3,20,7,7,21,4,8,3,11,34,5,3,13,11,5,10,3 };
    int minVotes;
    int maxVotes;
    cout << "Min Electorial Votes:";
    cin >> minVotes;
    cout << "Max Electorial Votes:";
    cin >> maxVotes;
